...
struct UberViewMapRepresentable: UIViewRepresentable {
...
extension UberViewMapRepresentable {
    
    class MapCoordinator: NSObject, MKMapViewDelegate {
        
        //MARK: - Properties
        
        let parent : UberViewMapRepresentable
        var userLocationCoordinate : CLLocationCoordinate2D?
        var currentRegion: MKCoordinateRegion?
        
        //MARK: - LifeCycles
        
        init(parent: UberViewMapRepresentable) {
            self.parent = parent
            super.init()
        }
